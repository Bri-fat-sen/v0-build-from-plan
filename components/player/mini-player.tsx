  ...
  return (
    <div className="glass-strong fixed bottom-12 left-0 right-0 z-30 border-t border-border lg:bottom-0">
      ...
      <div className="flex items-center gap-3 px-4 py-2">
        <button onClick={toggleFullScreen} className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={togglePlay} className="glow-orange-sm flex size-9 items-center justify-center rounded-full bg-primary text-primary-foreground">
